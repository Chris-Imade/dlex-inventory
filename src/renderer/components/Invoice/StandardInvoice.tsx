...
const StandardInvoice: React.FC<StandardInvoiceProp> = ({ data }) => {
  ...
  return (
    <div className="bg-[#ffffff] lg:min-w-[50rem] w-[30rem] mt-20 py-20 mb-6">
      <h3
        className="text-4xl text-slate-800 font-semi mx-[5rem]"
        style={{ fontFamily: fonts.family.roboto_bold }}
      >
        {serviceProvider?.companyName}
      </h3>
      <span
        className="text-sm text-slate-500 font-light mx-[5rem]"
        style={{ fontFamily: fonts.family.roboto_bold }}
      >
        Changing narrative with a touch of our ink.
      </span>
      ...
      <div className="flex justify-between mx-[5rem]">
        <div className="max-w-[12rem]">
          <h3
            ...
            style={{ fontFamily: fonts.family.roboto_bold, fontSize: 20 }}
          >
            Invoice to:
          </h3>
          <h3
            className="text-slate-800 text-xl"
            style={{ fontFamily: fonts.family.roboto_bold, fontSize: 14 }}
          >
            {data.clientName}
          </h3>
          <span
        ...
        <div className="flex items-start flex-col w-[19rem] ml-[-12rem]">
          <div className="flex items-center justify-between w-full">
            <h4
              className="text-slate-800 text-[1.2rem] mr-20"
              style={{ fontFamily: fonts.family.roboto_bold }}
            >
              Invoice#
            </h4>
            <h4 style={{ fontFamily: fonts.family.roboto_bold }}>
          ...
          <div className="flex items-center justify-between w-full">
            <h4
              className="text-slate-800 text-xl mr-20"
              style={{ fontFamily: fonts.family.roboto_bold, fontSize: 20 }}
            >
              Date
            </h4>
      ...
      <div className="lg:max-w-[70rem] mt-12 w-full flex justify-center items-center">
        <table className="w-full border-[1px] border-solid border-slate-600 mx-[5rem]">
          ...
          >
            <tr className="w-full">
              <td style={{ fontSize: 14 }} className="py-3 px-5">
                S/N.
              </td>
              <td style={{ fontSize: 14 }} className="py-3 px-5">
                Item Description
              ...
              return (
                ...
                >
                  <td
                    ...
                    className="py-3 px-5 text-slate-800"
                  >
                    {_ + 1}
                  </td>
                  <td
      ...
      <div className="h-5 mt-6 ml-[5rem] flex justify-between items-start mb-20">
        ...
        <div>
          ...
          <div
            className="flex justify-between items-center pr-[5rem] px-6 py-2"
